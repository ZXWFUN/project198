        ...
        <form id="art_form" class="layui-form" enctype="multipart/form-data">
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="L_filmname" name="filmname" value="{{ $film->filmname }}" required="" lay-verify="filmname"
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                    <img src="{{ $film->pic }}" alt="" style="width:120px">
                </div>
