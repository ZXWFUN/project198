...
<html>
  ...
  <body>
    ...
    <div class="x-body">
        <form id="art_form" class="layui-form" action="{{ url('article/modify/') }}/{{$aid->art_id}}" method="post" enctype="multipart/form-data">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <script type="text/javascript" charset="utf-8" src="/ueditor/lang/zh-cn/zh-cn.js"></script>
                     ...
                     <script name="art_content" id="editor" name="art_content" type="text/plain" style="width:900px;height:400px;"></script>
